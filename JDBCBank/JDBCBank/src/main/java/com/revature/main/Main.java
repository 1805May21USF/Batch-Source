    	...
    	while(flag) {
    		...
    		switch(input) {
    			...
    			case("view open accounts"):
    				try {
    					ArrayList<Account> accounts = adi.listAccounts("CUSTID = " + c.getId());
    		...
    		switch(input) {
    			case("view customer account"):
					...
					while(view == null) {
						...
						ArrayList<Customer> customers = cdi.getCustomerList("USERNAME = " + view);
    			...
    			case("view account information"):
    				...
    				while(viewAccount == null) {
						...
						// Retrieves any user with the entered username
						ArrayList<Account> accounts = adi.listAccounts("ACCOUNTID = " + viewAccount);
    		...
    		switch(input) {
    			...
    			case("view account"):
					...
					while(view == null) {
						...
						// Retrieves any user with the entered username
						ArrayList<Customer> customers = cdi.getCustomerList("USERNAME = " + view);
						ArrayList<Employee> employees = edi.getEmployeeList("USERNAME = " + view);
						...
						if(update.equals("customer")) {
							...
							while(cus == null) {
								...
								try {
									...
									ArrayList<Customer> customers = cdi.getCustomerList("USERNAME = " + s);
						...
						if(update.equals("employee")) {
							...
							while(emp == null) {
								...
								try {
									...
									ArrayList<Employee> employees = edi.getEmployeeList("USERNAME = " + s);
    			...
    			case("delete account"):
    				...
    				while(delete == null) {
    					...
    					if(delete.equals("customer")) {
    						...
    						ArrayList<Customer> customers = cdi.getCustomerList("USERNAME = " + cus);
    						...
    						ArrayList<Employee> employees = edi.getEmployeeList("USERNAME = " + cus);
