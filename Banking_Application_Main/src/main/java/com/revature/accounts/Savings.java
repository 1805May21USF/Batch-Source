...
public class Savings extends Account{
	...
	public Savings(String banking_account_id, int balance, int previous_transaction) {
	...
	public boolean withdraw(String banking_id, int new_balance, int old_balance) {
		try {
			...
			String sql = "{call withdraw_saving_account (?,?,?)}";
	...
	public boolean deposit(String banking_id, int new_balance, int old_balance) {
		try {
			...
			String sql = "{call deposit_saving_account (?,?,?)}";
