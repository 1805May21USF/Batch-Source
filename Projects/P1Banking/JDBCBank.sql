--TABLE CREATION FOR USERS, BANK_ACCOUNT, ACCOUNT_TRANSACTIONS
CREATE TABLE USERS
(
...
--PROCEDURES CALLED BY CALLABLE STATEMENTS IN JAVA CODE
...
--TRIGGERS CALLED WHEN DELETES OCCUR TO MAINTAIN REFERENTIAL INTEGRITY
