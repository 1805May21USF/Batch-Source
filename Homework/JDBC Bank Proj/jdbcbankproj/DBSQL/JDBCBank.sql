...
drop table "JACQTUMJDBCBANK"."BANKACCOUNT" cascade constraints 
drop table "JACQTUMJDBCBANK"."BANKACCOUNTSTATUS" cascade constraints 
drop table "JACQTUMJDBCBANK"."TRANSACTION_TYPE" cascade constraints 
drop table "JACQTUMJDBCBANK"."TRANSACTIONS" cascade constraints 
drop table "JACQTUMJDBCBANK"."USER_STATUS" cascade constraints 
drop table "JACQTUMJDBCBANK"."USER_TYPE" cascade constraints 
drop table "JACQTUMJDBCBANK"."USERS" cascade constraints 
...
LEFT JOIN BANKACCOUNT BA ON U.USER_ID = BA.USER_ID
--WHERE U.USER_TYPE_ID = 1 -- 1 IS SUPERUSER, 2 IS CUSTOMER
ORDER BY U.USER_ID, BA.BANK_ACCOUNT_ID
;
...
SELECT BANK_ACCOUNT_BALANCE FROM BANKACCOUNT WHERE USER_ID = 28 AND BANK_ACCOUNT_ID = 16;
...
SELECT U.USER_ID, U.USER_STATUS_ID, US.USER_STATUS, U.USER_FNAME, U.USER_LNAME, BA.BANK_ACCOUNT_ID, BA.BANK_ACCOUNT_BALANCE, BAS.BANK_ACCOUNT_STATUS_ID,
BAS.BANK_ACCOUNT_STATUS
FROM USERS U
LEFT JOIN BANKACCOUNT BA ON U.USER_ID = BA.USER_ID
LEFT JOIN USER_STATUS US ON U.USER_STATUS_ID = US.USER_STATUS_ID
LEFT JOIN BANKACCOUNTSTATUS BAS ON BA.BANK_ACCOUNT_STATUS_ID = BAS.BANK_ACCOUNT_STATUS_ID
WHERE U.USER_FNAME = 'SAM' AND U.USER_LNAME = 'SUNG';
