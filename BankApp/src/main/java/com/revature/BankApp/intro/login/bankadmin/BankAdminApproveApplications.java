...
public class BankAdminApproveApplications {
	Scanner input = new Scanner(System.in);

	BankAdminApproveApplications() {
		LoopB: while (true) {
			System.out.println("Approval Mode - Here are the list of open applications:");
			int count = 0;
			...
			if (Integer.parseInt(t) > (count - 1)) {
				...
				approveApplication(t, getAccountNumber(words));
				break LoopB;
			}
		}
	}

	/* Approve of account. The method will update the user's status from 0 to 1 */
	public void approveApplication(String username, long accountNo) {
